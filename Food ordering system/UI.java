        ...
        while (true) {
            ...
            if (choice == 1) {
                ...
                if (role.equals("owner")) {
                    ...
                    String id = restaurantController.registerRestaurant(email, restaurantName, restaurantAddress, phone);
...
//                                    }
                                    ...
                                    for (Map.Entry<String, String> entry : restaurantList.entrySet()) {
                                        System.out.print("Restaurant Id :  " + entry.getKey() + "       Name :  " + entry.getValue());
                                        System.out.print("      Address :  " + restaurantController.getRestaurentAddressByName(entry.getValue()));
                                        System.out.print("      Phone  :  " + restaurantController.getPhonenumberByResId(entry.getKey()));
                                        System.out.println();
                                    }
                                    break;
...
//                                                String foodItemId , String itemToAdd, String restaurantId, int price
                                ...
                                case 8:  //  register restaurant
                                    ...
                                    String registrationStatus = restaurantController.registerRestaurant(email, restaurantName, restaurantAddress, phone);
                                    ...
                                    if (sc.nextLine().equals("true")) {
                                        ...
                                        while (true) {
                                            ...
                                            if (isValidId) {
                                                ...
                                                System.out.println("Restaurant discontinued");
                                                break;
                                            } else {
                                                System.out.print("Enter a valid restaurant Id: ");
                                            }
                        ...
                        while (true) {
                            ...
                            switch (choice) {
                                ...
                                case 5:
                                    ...
                                    return;
                                case 6:  // Cancel order
                                    Map<String, String> pendingOrderList = orderController.getPendingOrderList(username , email); // getting food id and order id
